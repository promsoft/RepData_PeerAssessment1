...
The `r max.interval`-th 5-minute interval on average across all the days in the dataset (this one:  `r steps.per.interval$Group[max.interval]`) contains the maximum number of steps: `r max.interval`-th, this one:  `r steps.per.interval$Group[max.interval]`.
...
```
There is the mean total number of steps taken per day: `r sprintf("%8.2f", mean(steps.per.day.tidy$steps))`.
There is the median total number of steps taken per day: `r sprintf("%8.0f", median(steps.per.day.tidy$steps))`.
